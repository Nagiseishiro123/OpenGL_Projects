...
void setLight()
{
    ...
    const GLfloat leftLightSpecColor[] = { 1.0f, 1.0f, 0.0f, 0.5f };
    const GLfloat leftLightAmbColor[] = { 1.0f, 0.0f, 0.0f, 1.0f };
    ...
    const GLfloat rightLightAmbColor[] = { 0.0f, 0.0f, 1.0f, 1.0f };
